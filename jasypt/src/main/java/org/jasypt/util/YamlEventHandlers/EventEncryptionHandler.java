...
/**
 * This class will handle encryption of yml file.
 * It should only be instantiated with the parameterized constructor {@link #EventEncryptionHandler(Iterator, Properties, String)}
...
public class EventEncryptionHandler {
	 ...
	 * We'll identify the scalar values with the help of helper functions and encrypt them.
	 * @param eventItr
	 ...
	 * @throws Exception
	 */
	public EventEncryptionHandler(Iterator <Event> eventItr, Properties argumentValues, String location) throws IOException, Exception {
